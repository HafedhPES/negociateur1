...
const inputcss="border border-gray-300 mt-2 outline-none rounded-md px-1 py-2 focus:border focus:border-indigo-500 focus:shadow-md"
  ...
  <div className='flex flex-col w-[80%] sm:w-[60%] md:w-[50%] lg:w-[30%] h-[85%] sm:h-[82%] rounded-md bg-white px-3 py-3'>
...
<p className="flex justify-end text-sm mt-1 text-indigo-500 cursor-pointer">Mot de passe oublié ?</p>
...
<p className="flex mt-5 text-indigo-500 justify-center cursor-pointer">Créer un compte</p>
  </div>
