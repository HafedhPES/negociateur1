...
const Navbar= ()=>{
return(
    <div className=" drop-shadow-md flex fixed justify-between items-center w-screen h-[65px] bg-white border-b border-gray-100">
    ...
    <div className="hidden sm:flex justify-center w-3/12">
